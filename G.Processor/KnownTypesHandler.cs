...
using G.Core;
using Mono.Cecil;
using DataException = G.Data.DataException;
using SpecialNameAttribute = G.Data.Definition.SpecialNameAttribute;

namespace G.Processor
{
    public class KnownTypesHandler
    {
        public static readonly string GData = typeof(DbEntry).Assembly.FullName;
        ...
        public static readonly string DbViewAttribute = typeof(DbViewAttribute).FullName;
        ...
        private static TypeReference GetKeyType(TypeReference model)
        {
            ...
            if (model.IsGenericInstance && model.Namespace == "G.Data.Definition")
            {
