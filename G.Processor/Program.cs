...
Usage for process the dll which models included:
    G.Processor ModelsFileName [KeyFileName]

ModelsFileName: The assembly file name who has the model classes.
KeyFileName:    The strong name key pair file name.

Example:
    G.Processor Models.dll [@ReferenceFile1;ReferenceFile2...]
    G.Processor Models.dll models.snk [@ReferenceFile1;ReferenceFile2...]
");
        }
